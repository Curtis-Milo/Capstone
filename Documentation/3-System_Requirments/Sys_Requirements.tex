...
\multirow{5}{*}{\centering November 6\textsuperscript{th}, 2017}  & 
...
\cellcolor{tableCell}\textbf{Tid\#} &  \cellcolor{tableCell} Table identification and number \\
...
=======
	\item Error codes sent from Alfred (unsigned byte)
>>>>>>> bb878a034c7372cc85fa69f8569b402501b7f1b8
\end{itemize}
...
\textbf{Rationale} &  This will help simplify the scope of the project and reduce the amount of drink waste.\\ \hline
\end{longtable}
...
The following are the functional requirements of the project. They are separated into \# main components: drink serving robot (Alfred), ordering and administration.
...
% ----- 1 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF1} & Alfred shall be able to differentiate between the different drink types and dispense the correct drink.\\ \hline
\textbf{Rationale} & Alfred should be able to dispense the correct drinks for the customers.\\ \hline 
\end{longtable}

% ----- 2 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF2} & Alfred shall be able to identify to correlate a drink order to the requesting table.\\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF3} &  Alfred shall be able to navigate to a table that corresponds to a specific drink order. \\ \hline
\textbf{Rationale} & Alfred should be able to move autonomously. \\ \hline 
\end{longtable}

% ----- 4 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF4} & Alfred shall be able to pour the correct drinks corresponding to the specific tables order.\\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF5} & Alfred shall be able to dispense the correct amount for the drink based on the size of the cup specified.\\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF6} & Alfred shall be able to determine when liquids within storage containers are not within the desired temperature range.\\ \hline
\textbf{Rationale} &  In order to ensure that the drinks served meet FDA food regulation standards. \\ \hline 
\end{longtable}

% ----- 7 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF7} & Alfred shall be able to notify the staff when the liquids within the storage containers are not within the desired temperature range.\\ \hline
\textbf{Rationale} &  So that the staff will be able to make the appropriate action to cool the drinks down.\\ \hline 
\end{longtable}

% ----- 8 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF8} & Alfred shall be able to determine if any of the liquids within the storage containers are below the desired supply levels. \\ \hline
...
% ----- 9 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF9} & Alfred shall be able to notify the staff when any of the liquids within the storage containers are below the desired supply levels. \\ \hline 
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF10} & Alfred shall be able to determine if an obstacle is in its path and come to a timely stop. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF11} & Alfred shall be able to determine when a component will no longer be operational due to insufficient power levels. \\ \hline
...
% ----- 12 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF12} & Alfred shall be able to navigate back to the designated home base at any given point in time. \\ \hline
...
% ----- 13 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF13} & Alfred shall be able to indicate to the user when the drink has finished dispensing. \\ \hline
...
% ----- 14 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AF14} & Alfred shall be able to complete drink orders in the order that they were received.\\ \hline
...
% ----- 1 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{TO1} & The ordering application shall allow the user to be able to place an order to Alfred. \\ \hline
\textbf{Rationale} &  This is so that Alfred will be able to bring the beverages of the table.\\ \hline 
\end{longtable}

% ----- 2 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{TO2} & The ordering application shall be able to add the incoming order to Alfred's  the serving queue. \\ \hline
...
% ----- 1 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AD1} & The Administrator Application shall allow the user to create a map of the restaurant for Alfred. \\ \hline
...
% ----- 2 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AD2} & The Administrator Application shall allow the user to modify the map by adding or removing tables, obstacles and walkways.\\ \hline
\textbf{Rationale} &  To ensure that Alfred map is up to date and prevent damage of property.\\ \hline 
\end{longtable}

% ----- 3 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AD3} & The Administrator Application shall allow the user to view a log of the orders that were created by the ordering application. \\ \hline
\textbf{Rationale} &  This is so that the restaurant shall be able to make bills based on this information.\\ \hline 
\end{longtable}

% ----- 4 ----- %
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{AD4} & The Administrator Application shall be able to view Alfred's status at any given point in time. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR1} & Alfred shall have any functional equipment hidden within its containment unit unless the user needs to interact with it. \\ \hline
\textbf{Rationale} & Users should not have easy access to electrical or mechanical components for safety issues.\\ \hline 
\rowcolor{tableCell}\textbf{NFR2} & Alfred shall not have any exposed electronic wiring. \\ \hline
\textbf{Rationale} & To ensure user safety.\\ \hline 
\rowcolor{tableCell}\textbf{NFR3} & Alfred shall be at the appropriate table height. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR4} & Alfred shall be painted non-offensive and appealing colours. \\ \hline
\textbf{Rationale} & To ensure that no group of users is offended the choice of colours. \\ \hline  
\rowcolor{tableCell}\textbf{NFR5} & The drink ordering application shall not be visually cluttered. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR6} & Alfred shall make the drinks easy to grab and should only take the user 10 seconds to recognize the drink is ready and grab it. \\ \hline
\textbf{Rationale} & This is about the amount of time to determine that the cup is ready to grab it.\\ \hline 
\rowcolor{tableCell}\textbf{NFR7} & Alfred shall make it so the user to be able to tell when a drink is done within one second. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR8} & The ordering application shall make it so that the user can learn to order a drink within 2 minutes of use. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR9} & Alfred shall not say or portray anything that will offend a user of call out a specific group of users. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR11} & Alfred shall be able to determine the shortest path within 30 seconds. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NF12} & Alfred shall be able to pour a drink within 30 seconds. \\ \hline
\textbf{Rationale} & Approximate time for a person to dispense a drink. \\ \hline 
\rowcolor{tableCell}\textbf{NFR13} & Alfred shall be able to move at the walking speed of a human. \\ \hline
...
\rowcolor{tableCell}\textbf{NFR14} &  Alfred shall be able to receive an order within 30 seconds. \\ \hline
...
\rowcolor{tableCell}\textbf{NFR15} &  The ordering application be able to send an order to the administrative program within 30 seconds. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR16} &  Alfred shall be able to determine when an obstacle is three feet in front of it in order to stop. \\ \hline
\textbf{Rationale} & The estimated distance required to be able to decelerate properly.\\ \hline 
\rowcolor{tableCell}\textbf{NFR17} & Alfred shall not dispense a drink if supplies are not within the desired temperature range. \\ \hline
\textbf{Rationale} & To abide by FDA standards and to ensure user safety.\\ \hline 
\rowcolor{tableCell}\textbf{NFR18} & Alfred shall not exceed human walking speed.\\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR19} & Alfred shall be able to fill a cup within 75 to 85 percent of maximum capacity.\\ \hline
\textbf{Rationale} & The estimated amount so that the user will be satisfied as well as not overflowing the cup.\\ \hline 
\rowcolor{tableCell}\textbf{NFR20} & Alfred shall be able to get within one foot of any programmed node. \\ \hline
\textbf{Rationale} & To ensure ease of use with the user; they do not have to over reach for their drink. \\ \hline
\rowcolor{tableCell}\textbf{NFR21} & The system shall not distort the users order at any point if the drink order will not be able to be translated back. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR22} &  Alfred shall not allow liquid containers to leak. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR23} &  Alfred shall be able to store 2 Litres of any liquid. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR24} &  The system shall only require one work week to implement within any establishment. \\ \hline
\textbf{Rationale} & So that the system will be able to be introduced into a restaurant without disturbing workflow for extended periods of time.\\ \hline 
\end{longtable}
% ---------------------------- Longevity Requirements --------------------------%	
\subsubsection{Longevity Requirements }

\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR24} &  Alfred shall be able to keep drinks cold for 8 hours. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR25} & Alfred shall be able to determine if certain functions cannot be completed. \\ \hline
\textbf{Rationale} & To ensure that error reports are clear and concise. \\ \hline
\rowcolor{tableCell}\textbf{NFR26} & Alfred shall be able to determine the cause of a malfunction.\\ \hline
\textbf{Rationale} & To ensure that error reports are clear and concise. \\ \hline
\rowcolor{tableCell}\textbf{NFR27} &  Alfred shall be built so that components can be easily removed.\\ \hline \textbf{Rationale} & To ensure that components can be easily replaced if they malfunction.\\ \hline 
\end{longtable}
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR28} & The Administrator Application shall have help documentation available to the user. \\ \hline
\textbf{Rationale} &  To ensure that the user is able to get additional information if needed.\\ \hline
\rowcolor{tableCell}\textbf{NFR29} & The Table Ordering Application shall have help documentation available to the user. \\ \hline
\textbf{Rationale} & To ensure that the user is able to get additional information if needed.\\ \hline
\end{longtable}
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR30} & The Table Ordering Application shall allow the user to see what they have ordered. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR31} & The system shall encrypt all information.\\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR32} & The ordering system shall not display any information about other tables' drink orders.\\ \hline
\textbf{Rationale} &  To ensure information is kept private.\\ \hline 
\rowcolor{tableCell}\textbf{NFR33} & The system shall use secure protocols for any communication. \\ \hline
\textbf{Rationale} &  To ensure information is kept private.\\ \hline 
\end{longtable}
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR34} & Alfred shall have a cooling chamber to prevent drinks large increases in temperature. \\ \hline
\textbf{Rationale} & To ensure that Alfred abides by the FDA standards and to reduce the amount of trips to home base.\\ \hline 
\end{longtable}
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR35} & Alfred Shall follow food and safety regulations. \\ \hline
\textbf{Rationale} & To ensure that the restaurant is not at risk of failing public health inspections.\\ \hline
\rowcolor{tableCell}\textbf{NFR36} & Alfred shall not preform any actions that can be perceived as discriminatory to the user. \\ \hline
\textbf{Rationale} & To ensure that all users are comfortable using Alfred.\\ \hline 
\rowcolor{tableCell}\textbf{NFR37} & Alfred shall not server any alcoholic beverages or prohibited substances. \\ \hline
...
\begin{longtable}{| p{.15\textwidth } | p{.80\textwidth } | }\hline 
\rowcolor{tableCell}\textbf{NFR38} & Alfred shall follow the law of robotics. \\ \hline
